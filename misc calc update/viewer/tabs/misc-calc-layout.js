    ...
    <div class="misc-calc-container" style="display: flex; height: calc(100vh - 120px); font-family: sans-serif;">
      ...
      <div class="calc-sidebar" style="width: 250px; border-right: 1px solid #ccc; background: #f9f9f9; padding: 10px; overflow-y: auto;">
        ...
        <ul class="calc-nav-list" style="list-style: none; padding: 0; margin: 0;">
          ...
          <li class="calc-nav-item" data-target="mc-flange-check" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Flange Check</li>
          <li class="calc-nav-item" data-target="mc-gre-flange" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">GRE Flange Leakage</li>
          <li class="calc-nav-item" data-target="mc-api610" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee; background: #fff0f0;">API 610 Nozzle Loads</li>
          <li class="calc-nav-item" data-target="mc-aiv-fiv" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">AIV / FIV Checks</li>
          <li class="calc-nav-item" data-target="mc-ext-pressure" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">External Pressure (ASME VIII)</li>
          <li class="calc-nav-item" data-target="mc-welded-shoe" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Welded Shoe</li>
          ...
          <li class="calc-nav-item" data-target="mc-rvforce" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Gas/Vapour Relief Reaction</li>
          <li class="calc-nav-item" data-target="mc-liquidrelief" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Liquid Relief</li>
          <li class="calc-nav-item" data-target="mc-psvopen" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">PSV Open</li>
          <li class="calc-nav-item" data-target="mc-bdliquid" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Bursting Disc Liquid</li>
          <li class="calc-nav-item" data-target="mc-blast" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Blast</li>
          ...
          <li class="calc-nav-item" data-target="mc-slug" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee;">Slug Loads</li>
          <li class="calc-nav-item" data-target="mc-shellindent" style="padding: 10px; cursor: pointer; border-bottom: 1px solid #eee; font-weight: bold; color: #1a5fa3;">Pipe Shell Indentation</li>
        </ul>
      </div>
