export const SlugLoadsCalc = {
  id: 'mc-slug',
  name: 'Slug Loads (Time History Rev A)',
  method: 'Momentum / DAF Evaluation (Time History Update Pending)',
  ...
  run: (envelope) => {
    ...
    envelope.warnings.push('Time-History dynamic multipliers (short slug / long slug) pending full Source Extraction.');
