...
def test_glb_pcf():
    with sync_playwright() as p:
        ...
        try:
            ...
            page.locator('#glb-color-prop').select_option(value='bore')
            page.wait_for_timeout(1000)

            is_legend_visible = page.locator('#glb-legend-panel').is_visible()
            print("Legend visible:", is_legend_visible)

            page.screenshot(path='/home/jules/verification/glb-heatmap.png', full_page=True)
