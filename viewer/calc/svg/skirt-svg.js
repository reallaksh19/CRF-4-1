...
export function generateSkirtSvg(inputs) {
  ...
  const svg = `
    ...
    <!-- Skirt walls -->
    <rect x="50" y="100" width="${Math.min(t_wall, 20)}" height="200" fill="#ccc" stroke="#333"/>
    <rect x="${250 - Math.min(t_wall, 20)}" y="100" width="${Math.min(t_wall, 20)}" height="200" fill="#ccc" stroke="#333"/>
    ...
    ${drawDimension(50, 200, 50 + Math.min(t_wall, 20), 200, `t = ${t_wall} mm`, -30)}
