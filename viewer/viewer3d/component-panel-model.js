...
function processRows(comp) {
  ...
  const rows = [
    ...
    ['Wall', getKey('WALLTHK') || a['COMPONENT-ATTRIBUTE4'] || '-'],
...
function supportRows(comp) {
  ...
  return [
    ...
    ['SUPPORT_TAG', a.SUPPORT_TAG || '-'],
    ['SUPPORT_GUID', a.SUPPORT_GUID || '-'],
    ['SUPPORT_DESC', a.SUPPORT_DESC || '-'],
    ['SUPPORT_DOFS', a.SUPPORT_DOFS || '-'],
    ['AXIS_COSINES', a.AXIS_COSINES || '-'],
    ['PIPE_AXIS_COSINES', a.PIPE_AXIS_COSINES || '-'],
    ['Inferred Block (CAxxx)', inferBlock(a)],
